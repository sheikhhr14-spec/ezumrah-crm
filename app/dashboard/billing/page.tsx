...
export default async function BillingPage() {
  ...
  // auto-issue this month's SaaS invoice if missing
  ...
  return (
    <div>
      ...
      <p className="mb-6 text-xs text-slate-400">Payments are verified by the EzUmrah admin team. Online payment arrives with Stripe setup.</p>
      <div className="mb-6 grid gap-4 sm:grid-cols-3">
        ...
        <div className="card p-5">
          ...
          <p className="text-xs text-slate-400">To upgrade or cancel, contact EzTechify support.</p>
        </div>
        <div className="card p-5">
