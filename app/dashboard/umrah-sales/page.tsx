  ...
  return (
    <div>
      ...
      <div className="card mb-6 p-5">
        ...
        <PackageSaleForm category="umrah" customers={(customers || []).map((c: any) => ({ id: c.id, full_name: c.full_name }))}  currency={(agctx.agency || {}).currency} taxRate={Number((agctx.agency || {}).tax_rate || 0)} />
      </div>
