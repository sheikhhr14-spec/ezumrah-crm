...
export const SERVICE_SALES: Record<string, SvcConfig> = {
  hotel_sales: {
    ...
    fields: [
      ...
      { name: 'source', label: 'Source / referral', ph: 'website / referral / repeat client' },
      { name: 'tags', label: 'Tags', ph: 'vip, group, ramadan' },
  ...
  visa_sales: {
    ...
    fields: [
      ...
      { name: 'due_date', label: 'Payment due date', type: 'date' },
      { name: 'embassy_submission_date', label: 'Embassy submission', type: 'date' },
